      ...
      {informations.map((info, index) => (
        <div
          className={`information-item ${
            info.title === "Tanggal Pelaksanaan UTBK SNBT 2026" ? "reverse" : ""
          }`}
          key={index}>
          ...
          <div className="information-image-container">
            <img
              ...
              alt={`Ilustrasi informasi ${
                ...
                info.title === "Kouta Jalur SNBT UTBK 2026"
                  ? "alokasi kouta yang tersedia untuk berbagai jalur masuk SNBT 2026"
                  : "jadwal penting pelaksanaan UTBK SNBT 2026 di bulan Mei, yang terdiri dari beberapa sesi ujian."
              }`}
