import "./UnivPengajarLps.css";
const UnivPengajarLps = () => {
  return (
    <div className="univ__pengajar_lps__container">
      <p className="centered__pengajarLps">
        Pengajar LPS adalah dosen, asisten dosen, guru, mahasiswa berprestasi
        dan alumni UI, UGM, ITB, IPB, STAN, STIS, UNJ, SSE, UIN dan berbagai
...
export default UnivPengajarLps;
