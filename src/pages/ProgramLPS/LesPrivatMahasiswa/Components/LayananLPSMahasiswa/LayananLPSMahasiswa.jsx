import "./LayananLPSMahasiswa.css";
  ...
  return (
    <div>
      ...
      <ul className="program-simak-ui-list">
        ...
        <li>Les Privat Matematika Dasar</li>
        <li>Les Privat Kimia Dasar</li>
        <li>Les Privat Fisika Dasar</li>
        ...
        <li>Les Privat Matematika Akuntansi</li>
        <li>Les Privat Intermediate Accounting</li>
        <li>Les Privat Akuntansi Keuangan</li>
        <li>Les Privat Matematika Ekonomi</li>
        ...
        <li>Les Privat Ekonomi Teknik</li>
        <li>Les Privat Manajemen Keuangan</li>
        <li>Les Privat Kewirausahaan</li>
        <li>Les Privat Mekanika Bahan</li>
        <li>Les Privat Derivatif Market</li>
        <li>Les Privat Keuangan dan Perbankan</li>
...
export default LayananLPSMahasiswa;
