  ...
  return (
    <div className="program-simak-ui-container">
      ...
      <p className="program-simak-ui-description">
        <span className="color-d2b04c-description">LPS Matrix</span> membuka LPS
        membuka program Les Privat Simak UI S2 yang ditujukan untuk siswa yang
        akan mengikuti Seleksi Masuk Universitas Indonesia untuk Program Pasca
        Sajarna. Berikut merupakan Program Khusus Simak UI
      </p>
