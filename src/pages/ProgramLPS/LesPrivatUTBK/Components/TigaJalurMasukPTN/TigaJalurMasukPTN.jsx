    ...
    <div className="container-tiga-jalur">
      ...
      <div className="card-container-tiga-jalur">
        ...
        <div className="card-tiga-jalur">
          ...
          <p className="card-description-tiga-jalur">
            ...
            tinggi dan prestasi lain selama sekolah.
          </p>
        </div>
        ...
        <div className="card-tiga-jalur">
          ...
          <p className="card-description-tiga-jalur">
            ...
            melalui ujian tertulis. Jalur ini terbuka untuk semua siswa dan
            biasanya mencakup tes kemampuan akademik dan kemampuan dasar yang
      ...
      <p className="additional-description">
        <span className="color-d2b04c-description">
          {" "}
          LPS (Les Privat SBMPTN) Jakarta
        </span>{" "}
        adalah Lembaga Penyedia Jasa Guru Les Privat Profesional dan Bimbingan
        Belajar yang berdiri sejak tahun 2010 serta telah memiliki ribuan siswa
        dari berbagai wilayah di Indonesia seperti Jakarta, Bogor, Depok,
        Tangerang, Tangsel, Bekasi, BSD, Bandung, Semarang, Yogyakarta,
        Surabaya, Denpasar, Serang, Banda Aceh, Medan, Palembang, Padang,
        Bengkulu, Pekanbaru, Tanjung Pinang, Jambi, Bandar Lampung, Pangkal
        Pinang, Pontianak, Samarinda, Banjarmasin, Palangkaraya, Tanjung Selor,
        Kupang, Mataram, Gorontalo, Mamuju, Palu, Manado, Kendari, Makasar,
        Ternate, Ambon, Manokwari, Jayapura dan daerah lain.
      </p>
      <p className="additional-description">
        Selain Program{" "}
        <span className="color-d2b04c-description"> Les Privat SNBT</span> dan
        Ujian Masuk PTN lainnya, LPS juga menyediakan Program Les Privat untuk
